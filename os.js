...
function renderAgenda(){
  ...
  ;(allActivities||[]).filter(a => a.is_active && a.hora_sugerida && ['diaria','recurrente'].includes(a.frequency||'diaria') && !['skincare_sub','limpieza_sub','secundarios_manana','secundarios_tarde','secundarios_noche','identidad_diaria','trabajo_profundo','trabajo_profundo_meta'].includes(a.category))
    .forEach(a => {
