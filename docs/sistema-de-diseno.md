...
| **Input** / **Select** / **Textarea** | `inputs.tsx` | server | Controles con estilo del sistema (fondo `canvas`, borde `line`, radio 6px, `.focus-ring`). Sin `w-full` en la base (para que sirvan inline en QuickCapture). |
